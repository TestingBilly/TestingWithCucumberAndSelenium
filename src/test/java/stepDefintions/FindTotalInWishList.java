...
//    }
    public void lookAtWishListAndGetPrices() {
     ...
     //   driver.findElement(By.cssSelector(".header-wishlist:nth-child(3) .lar")).click();
        ...
        price1 = this.driver.findElement(By.xpath("//td[4]")).getText();
        itemPrice1 = Double.parseDouble(price1);
        price2 = this.driver.findElement(By.xpath("//tr[2]/td[4]")).getText();
        itemPrice2 = Double.parseDouble(price2);
        price3 = this.driver.findElement(By.xpath("//tr[3]/td[4]")).getText();
        itemPrice3 = Double.parseDouble(price3);
        price4 = this.driver.findElement(By.xpath("//tr[4]/td[4]")).getText();
